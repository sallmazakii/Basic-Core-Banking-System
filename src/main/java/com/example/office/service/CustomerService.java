...
public class CustomerService {
    final com.example.office.repo.customerRepo customerRepo;
    ...
    public Customer createCustomer (CustomerDTO customerDTO){
        Office office=officeRepo.findById(customerDTO.getOfficeID()).orElseThrow(()->new NotFoundException("Office Not Found"));
